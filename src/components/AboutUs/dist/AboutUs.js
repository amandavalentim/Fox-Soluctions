...
var AboutUs = function () {
    return (react_1["default"].createElement(AboutUsComponent, null,
        react_1["default"].createElement("nav", { className: 'section' },
        ...
        react_1["default"].createElement("nav", { className: 'company-desktop' },
            react_1["default"].createElement("div", { className: "container-company-desktop" }))));
};
